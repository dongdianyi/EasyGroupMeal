package gzkj.easygroupmeal.datepicker;
...
public class CustomDatePicker {
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            ...
            datePickerDialog.getWindow().setWindowAnimations(R.style.BottomDialog_Animation);
    ...
    private void initView() {
        year_pv = datePickerDialog.findViewById(R.id.dpv_year);
        month_pv = datePickerDialog.findViewById(R.id.dpv_month);
        day_pv = datePickerDialog.findViewById(R.id.dpv_day);
        hour_pv = datePickerDialog.findViewById(R.id.dpv_hour);
        minute_pv = datePickerDialog.findViewById(R.id.dpv_minute);
        tv_cancle = datePickerDialog.findViewById(R.id.tv_cancel);
        tv_select = datePickerDialog.findViewById(R.id.tv_confirm);
        hour_text = datePickerDialog.findViewById(R.id.tv_hour_unit);
        minute_text = datePickerDialog.findViewById(R.id.tv_minute_unit);
        year_text = datePickerDialog.findViewById(R.id.tv_year_unit);
        month_text = datePickerDialog.findViewById(R.id.tv_month_unit);
        day_text = datePickerDialog.findViewById(R.id.tv_day_unit);
     ...
     * 设置日期控件只显示时分
     */
    public void showSpecificTime2(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
     ...
     * 设置日期控件只显示年月
     */
    public void showSpecificTime3(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
                hour_pv.setVisibility(View.GONE);
     ...
     * 设置日期控件只显示年月日
     */
    public void showSpecificTime4(boolean show) {
        if (canAccess) {
            if (show) {
                disScrollUnit();
                hour_pv.setVisibility(View.GONE);
    ...
    public void setCanShowAnim(boolean canShowAnim) {
        ...
        year_pv.setCanShowAnim(canShowAnim);
        month_pv.setCanShowAnim(canShowAnim);
        day_pv.setCanShowAnim(canShowAnim);
        hour_pv.setCanShowAnim(canShowAnim);
        minute_pv.setCanShowAnim(canShowAnim);
    }
    /**
     * 验证字符串是否是一个合法的日期格式
     */
