...
public class VerificationCodeView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            isWrapContent=true;
            mWidth=(int)(textPaint.measureText("0")*1.5*codeNum+20+DensityUtil.dip2px(getContext(),8));
        }
        ...
        if (heightMode == MeasureSpec.EXACTLY) {
            ...
            mHeight= (int) DensityUtil.dip2px(getContext(),40);
        }
    ...
    private void initView() {
        ...
        maxTextSize=DensityUtil.dip2px(getContext(),50);
        defaultTextSize=DensityUtil.dip2px(getContext(),30);
        textPaint=new Paint();
    ...
    private void createCodeBitmap() {
        ...
        if (!isWrapContent){
            ...
            horizontalOffset= (int) ((mWidth-drawWidth-DensityUtil.dip2px(getContext(),8))/2);
    ...
    private void dynamicSetTextPaint(String text){
        int avaiWidth = (int) (mWidth*2.0f/3 - getPaddingLeft() - getPaddingRight() - DensityUtil.dip2px(getContext(), 2));
        if (avaiWidth <= 0) {
            return;
        }
