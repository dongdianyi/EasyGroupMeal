 ...
 */
package meal.group.easy.gzkj.calendarlibrary;
...
public class CalendarLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mMonthView = findViewById(R.id.vp_calendar).findViewById(R.id.vp_calendar);
        mWeekPager = findViewById(R.id.vp_week).findViewById(R.id.vp_week);
